...
#Question 10: WAF to find max in input nos.
...
#Question 11:WAF to adding all nos. of list without using sum() fn
...
#Quesrion 12: WAF to find highest no. without using max() fn

numb = [6,3,2,9,8,6,1,0]


def find_largest(list_par):
    highest = -1
    for el in list_par:
        if el > highest :
            highest = el
